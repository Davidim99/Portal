    ...
    <as
      ...
      <div class="collapse navbar-collapse" id="click-movil">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li>
            <a href="<?php echo URL ?>index.php/portal/nuevo">Registrate</a>
          </li>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <form class="form" role="form" method="post" accept-charset="UTF-8" id="login-nav">
                      ...
                      <div class="form-group">
                        <a href="<?php echo URL ?>index.php/usuariosPortal/usuIndex">Iniciar sesion</a>
                      </div>
                  ...
                  <div class="bottom text-center">
                    Nuevo Aqui ? <a href="<?php echo URL ?>index.php/panel/panel"><b>Registrate</b></a>
                  </div>
                </div>
              </li>
            </ul>
