      ...
      <div id="carousel-1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img id="banner" src='<?php echo URL ?>pictures/fondo4-a.jpg' class="img-responsive">
          ...
          <div class="item">
            <img id="banner" src='<?php echo URL ?>pictures/fondo4-b.jpg' class="img-responsive">
            <div class="carousel-caption">
          ...
          <div class="item">
            <img id="banner" src='<?php echo URL ?>pictures/fondo4-c.jpg' class="img-responsive">
            <div class="carousel-caption">
